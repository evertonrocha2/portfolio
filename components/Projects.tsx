  ...
  const projects = [
    {
      image: "img-01.png",
      title: "Muve Delivery",
      description: "Desenvolvimento de uma solução digital para a Muve Delivery, uma empresa especializada no mercado de entregas, com o objetivo de otimizar e facilitar a gestão e acompanhamento dos pedidos.",
      href:"https://app.muve.delivery/"
    },
    {
      image: "img-02.png",
      title: "Weight Speed",
      description: "Criação de uma plataforma inovadora voltada para o emagrecimento, com ferramentas personalizadas que ajudam as pessoas a alcançar seus objetivos de forma saudável e eficiente.",
      href:"https://github.com/evertonrocha2/magnareid"
    },
    {
      image: "img-03.png",
      title: "CurrencyHub",
      description: "Desenvolvimento de um sistema de conversão de moedas que utiliza uma API externa para fornecer dados de câmbio atualizados em tempo real, facilitando transações internacionais.",
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-16"
      >
        <ShimmerButton href="https://github.com/evertonrocha2" words="Acessar GitHub!" />
      </motion.div>
    </motion.div>
  );
};
