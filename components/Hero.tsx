...
const Hero = () => {
  const title = "Este é o meu portfólio, onde transformo conceitos em experiências incríveis.";
    ...
    <div id="hero" className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        <div className="flex gap-2">
          ...
          <TextGenerateEffect duration={1} words={title} className="text-center pointer-events-none text-white dm-sans text-[40px] md:text-5xl lg:text-6xl tracking-tighter" />
          <TextGenerateEffect duration={2} words={about} className="text-center pointer-events-none text-zinc-300 mb-4 text-sm" />
        </div>
      </div>
    </div>
  );
