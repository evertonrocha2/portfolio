...
const ExperienceAndSkills = () => {
  return (
    <div id="skills" className="w-full flex-col h-screen flex items-center justify-center pt-20">
      ...
      <div>
        ...
        <div className="flex flex-col gap-2  items-center justify-center">
          <div>
            <h3 className="tracking-tighter font-semibold pointer-events-none">Frontend</h3>
          </div>
          <div className="flex">
            {frontend.map((item, i) => (
              <Tooltip key={i}>
        ...
        <div className="flex flex-col gap-2  items-center justify-center">
          <div>
            <h3 className="tracking-tighter font-semibold pointer-events-none">Backend</h3>
          </div>
          <div className="flex">
            {backend.map((item, i) => (
              <Tooltip key={i}>
        ...
        <div className="flex flex-col gap-2 items-center justify-center">
          <div>
            <h3 className="tracking-tighter font-semibold pointer-events-none">DevOps</h3>
          </div>
          <div className="flex">
            {devops.map((item, i) => (
                <Tooltip key={i}>
        ...
        <div className="flex flex-col gap-2  items-center justify-center">
          <div>
            <h3 className="tracking-tighter font-semibold pointer-events-none">Tools</h3>
          </div>
          <div className="flex">
            {tools.map((item, i) => (
              <Tooltip key={i}>
